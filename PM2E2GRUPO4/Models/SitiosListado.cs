...
namespace PM2E2GRUPO4.Models
{
    ...
    {
        public SitiosListado(string Id, string Descripcion, string Latitud, string Longitud, ImageSource fotografia, string Foto, string Audio, byte[] decodedStringAudio)
        {
            this.Id = Id;
